                            ...
                            <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/40 p-4">
                                <div className="bg-white rounded-2xl shadow-xl w-full max-w-2xl p-6">
                                    <div className="flex items-center justify-between mb-4">
                                        ...
                                        <button onClick={() => setShowModal(false)} className="text-gray-500 hover:text-gray-700">Cerrar</button>
                                    </div>
                                    <form onSubmit={handleCreateCita} className="space-y-3">
                                        {/* Buscar paciente existente (usa RPC 'buscar_pacientes') */}
                                        <div>
                                            ...
                                            {/* Si ya se seleccionó un paciente, mostrar resumen y opción de quitar */}
                                            ...
                                            {/* Resultados de búsqueda o lista local (fallback) */}
                                        ...
                                        <div className="flex items-center justify-end gap-3 mt-4">
                                            <button type="button" onClick={() => setShowModal(false)} className="px-4 py-2 rounded-lg bg-gray-100">Cancelar</button>
