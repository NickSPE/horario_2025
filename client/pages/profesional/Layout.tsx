...
import { Clock, Home, LogOut, Menu, Moon, Pill, Sun, User } from "lucide-react";
...
function NavigationContent({
  ...
  return (
    <div className="flex flex-col h-full">
      {/* Contenedor desplazable para la info y navegación */}
      ...
      {/* Sección inferior fija (sticky dentro del scroll container) */}
      <div className="sticky bottom-0 border-t pt-3 space-y-3 bg-muted/30 dark:bg-muted/10">
        {/* Dark Mode Toggle */}
        <Button
          variant="ghost"
          size="lg"
  ...
  return (
    <div className="min-h-screen flex flex-col md:flex-row">
      ...
      <aside className="hidden md:flex md:w-72 lg:w-80 border-r bg-muted/30 dark:bg-muted/10 fixed h-screen">
        <div className="flex flex-col h-screen w-full relative p-6">
          <NavigationContent toggleDarkMode={toggleDarkMode} darkMode={darkMode} />
        </div>
      </aside>
